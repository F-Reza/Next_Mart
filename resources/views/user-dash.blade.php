...
<head>
    ...
    <title>Next Mart - Responsive Header</title>
...
<body>
    ...
    <div class="demo-content">
        <div class="demo-section">
            ...
            <p>This page demonstrates the improved responsive header for Next Mart. The header includes:</p>
            <ul>
                <li>Fully responsive design that works on mobile, tablet, and desktop</li>
                <li>Enhanced cart and wishlist with badge notifications</li>
                <li>User account dropdown with login/register options</li>
                <li>Search functionality with responsive behavior</li>
                <li>Category navigation with dropdown menus</li>
                <li>Mobile-friendly menu with slide-out panel</li>
            </ul>
            <p>Resize your browser window to see how the header adapts to different screen sizes.</p>
        </div>

        <div class="demo-section">
            <h3>Mobile View Features</h3>
            <p>On mobile devices:</p>
            <ul>
                <li>The logo size adjusts for smaller screens</li>
                <li>Action buttons collapse to icons only</li>
                <li>Category navigation becomes horizontally scrollable</li>
                <li>Hamburger menu provides access to full navigation</li>
                <li>Search bar moves below the top bar for better usability</li>
            </ul>
        </div>
    </div>
